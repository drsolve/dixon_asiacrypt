...
\begin{hypothesis}[Degree Minimization Heuristic]\label{hyp:deg_mini_hypo}
	...
	then we expect $\deg(\det(A)) \geq \deg(\det(B))$ to hold generically.
\end{hypothesis}
