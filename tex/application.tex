...
\begin{figure}[h]
\centering
\includegraphics[width=0.95\textwidth]{xhash_complexity.pdf}
...
\begin{table}[hbtp!]
\centering
\caption{Experimental time comparison for small \xhash instances with $c=1$, where $\alpha=3$ for the two-step instances and $\alpha=7$ for the three-step instance. The complexities (Comp.) are in $\log_2$ field operations. $\omega = 2.81$. The Method~1 entries are obtained from~\eqref{eq:dixon_complexity_well} with the equation count and degree read from the instance; both two-step instances consist of $6$ equations of degree $3$ and therefore share the same estimate.}
