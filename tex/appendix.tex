...
\begin{figure}[H]
	...
	\par\smallskip
	\begingroup\small\noindent
	\textbf{Fig.~\ref{fig:complexity} (continued).} The bottom panel uses $\omega=2.37$. Since the asymptotic dominance of the final determinant sets in only for larger $(n,d)$ than those plotted, the Dixon curve of this panel reports the maximum over the two symbolic stages, $\max\{T_{1}^{\mathrm{best}},T_{4}^{\mathrm{best}}\}$, which over this range is governed by Step~1.\par
	\endgroup
\end{figure}
