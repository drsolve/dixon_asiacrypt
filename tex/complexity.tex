...
\le\frac{(nd)^{n-1}}{n!},
\]
which also verifies the integer volume bound $B_{\mathrm{MH}}$ in~\eqref{eq:Dixon_volume_bound}. Numerical comparisons and support-size experiments are given in Appendix~\ref{appendix:experimental_bound}.
