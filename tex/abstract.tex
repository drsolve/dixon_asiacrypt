\begin{abstract}
	...
	We revisit the Dixon resultant as an efficient and flexible tool for eliminating several variables simultaneously. We derive refined upper bounds on the Dixon matrix size via lattice-path counting and analyze the complexity under several determinant computation models, yielding explicit complexity estimates. For well-determined systems, the Dixon resultant is a viable alternative to Gr\"obner basis methods; it is moreover attractive for elimination in under-determined systems, whereas Gr\"obner basis methods remain preferable for over-determined ones.
