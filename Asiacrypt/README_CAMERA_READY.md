...
The generated `main.pdf` has 36 pages. The paper body, acknowledgements, and disclosure occupy 30 pages; the bibliography begins on page 30 and is excluded from the conference's 30-page limit. The appendices are available in the full version on the Cryptology ePrint Archive (Paper 2026/1969).
